...
namespace RVO
{
    ...
    public class Simulator
    {
        ...
        /**
         * <summary>Remove an agent from the simulation.</summary>
         *
         * <returns>True if removal success otherwise false.</returns>
         *
         * <param name="id">Id of the agent to be removed.</param>
         */
        ...
        /**
         * <summary>Returns the keys of the agents dictionary.
         * </summary>
         *
         * <returns>The keys of the agents dictionary.</returns>
         */
        public int[] getAgentsKeysArray()
        {
            return agents_.Keys.ToArray();
        }
